...
const userSchema = new mongoose.Schema({
    ...
    // List of actions made with chats
    chatAction: [new Schema({
        post: { type: Schema.ObjectId, ref: 'Script' }, // The unique ID for the post within the database, the post the user interacted with for chat
        messages: [new Schema({
